  ...
  return (
    <AuthenticatedLayout>
      ...
      <div className="max-w-full overflow-hidden py-4 px-3 sm:px-6 font-plusmedium">
        {flash && (
          <div className="mb-4 p-3 rounded-lg bg-green-100 text-green-800 font-plusmedium">{flash}</div>
        )}
                ...
                {paginated.length > 0 ? (
                  paginated.map((p, i) => (
                    <tr key={p.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-4 whitespace-nowrap">{p.tanggal_peminjam}</td>
                      <td className="px-4 py-4 whitespace-nowrap">{p.tanggal_kembali || '-'}</td>
