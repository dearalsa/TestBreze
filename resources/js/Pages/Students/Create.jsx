...
  const fileClass =
    'w-full border border-gray-300 rounded-xl p-2.5 bg-gray-50 text-sm focus:outline-none focus:ring-0 focus:border-gray-300 focus:bg-gray-50 active:bg-gray-50 font-plusregular';
  const labelClass = 'block text-gray-700 font-plusmedium mb-1';
...
        <h2 className="text-3xl font-plusmedium text-gray-800 mb-6">Tambah Data Siswa</h2>
...
            </div>
            <div>
              <label className={labelClass}>Foto Wajah</label>
              <input
                type="file"
                accept="image/*"
...
              />
              {formattedTanggal && (
                <p className="text-gray-500 text-sm mt-1 font-plusregular">Format: {formattedTanggal}</p>
              )}
            </div>
            <div>
...
              type="submit"
              disabled={processing}
              className="bg-blue-600 hover:bg-blue-700 text-white font-plusmedium py-2.5 px-8 rounded-xl shadow disabled:opacity-50 text-base"
            >
