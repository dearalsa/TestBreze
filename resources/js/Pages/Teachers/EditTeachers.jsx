...
export default function EditTeachers({ teacher }) {
  ...
  return (
    <AuthenticatedLayout>
      ...
      <div className="max-w-4xl mx-auto p-6">
        ...
        <h2 className="text-3xl font-plusmedium mb-6 text-gray-800">Edit Guru</h2>
        ...
        <form onSubmit={handleSubmit} className="bg-white shadow-md rounded-2xl p-6 space-y-6">
          ...
          <div className="flex justify-end pt-4">
            <button
              type="submit"
              disabled={processing}
              className="bg-blue-600 hover:bg-blue-700 text-white font-plusmedium py-2.5 px-8 rounded-xl transition duration-150 ease-in-out"
            >
