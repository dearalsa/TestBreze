      ...
      >
        ...
        <form onSubmit={submit} className="mt-8 space-y-6">
          {["name", "email", "password", "password_confirmation"].map((field) => (
            <div key={field}>
              <label className="block text-sm text-gray-700 font-comfortaa">
              ...
              <input
                ...
                placeholder={`Enter your ${field === "password_confirmation" ? "password again" : field}`}
              ...
              />
              {errors[field] && <div className="text-red-500 text-xs font-comfortaa">{errors[field]}</div>}
            </div>
          ))}
